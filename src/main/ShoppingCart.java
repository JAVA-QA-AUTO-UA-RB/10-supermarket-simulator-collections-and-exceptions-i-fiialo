...
import main.exceptions.CartLimitExceededException;
...
public class ShoppingCart {
    ...
    public void addToCart(String product) {
        if (cart.size() >= CART_LIMIT) {
            throw new CartLimitExceededException("Максимум " + CART_LIMIT + " товарів в кошику");
        }
        cart.add(product);
    }
    ...
    public void checkout(PriceCatalog catalog, double payment)
        ...
        System.out.printf("Оплата пройшла. Загальна сума: %.2f (ПДВ: %.2f, знижка: %.0f%%)\n",
